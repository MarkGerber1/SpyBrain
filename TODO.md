...
- [ ] Добавить интеграционные UI-тесты (Compose/Espresso) для переходов и смены языка
- [ ] Провести ручное тестирование на разных устройствах
- [ ] Улучшить обработку ошибок камеры и разрешений
- [ ] Добавить подробную документацию по новым модулям
- [ ] Покрыть UI-сценарии для всех состояний: loading, error, empty, success
- [ ] Проверить работу вибрации на разных устройствах
- [ ] Провести аудит локализации (en/ru)
- [ ] Проверить миграции Room и DataStore
- [ ] Провести нагрузочное тестирование экрана пульса 