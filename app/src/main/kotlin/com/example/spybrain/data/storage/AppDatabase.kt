...
@Database(
    entities = [BreathingSessionEntity::class, MeditationSessionEntity::class, UserProfileEntity::class, CustomBreathingPatternEntity::class, AchievementEntity::class],
    version = 3,
